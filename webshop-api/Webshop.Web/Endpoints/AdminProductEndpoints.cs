...
using Webshop.Core.Features.Products.V1.UpdateProductCommand;
...
namespace Webshop.Web.Endpoints
{
    public class AdminProductEndpoints : IEndpoints
    {
        ...
        public static void DefineEndpoints(IEndpointRouteBuilder app)
        {
            ...
            app.MapPut(ApiEndpoints.Admin.Update, UpdateAsync)
            ...
            app.MapDelete(ApiEndpoints.Admin.Delete, DeleteAsync)
        ...
        internal static async Task<IResult> DeleteAsync(Guid id, IMediator mediator)
        {
